    ...
    <div class="dashboard-body-part">
        <div class="row">
            ...
            <div class="col-xl-4  text-xl-end text-center">
                <a href="{{ route('user.ticket.index') }}" class="site-color"><i class="fas fa-arrow-left"></i> {{ __('Back to Ticket List') }}</a>
            </div>
        </div>
                    ...
                    <form action="{{ route('user.ticket.reply', $ticket->id) }}" enctype="multipart/form-data"
                        ...
                        <div class="row justify-content-md-between">
                            ...
                            <div class="col-lg-12 mt-3 text-end">
                                <button type="submit" class="btn btn-primary ticket-reply"><i class="fas fa-reply"></i>
                                    {{ __('Reply') }}
                                </button>
                            </div>
                        </div>
