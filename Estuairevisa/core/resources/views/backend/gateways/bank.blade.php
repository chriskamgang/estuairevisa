                                ...
                                <div class="row">
                                   <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="">{{__('Choose Network')}}</label>
                                    ...
                                    <div class="form-group col-md-6">
                                     ...
                                     <div class="form-group col-md-12">
                                        ...
                                        <label for="">{{__('Details for payment ')}}</label>
                                        <textarea type="text" name="branch_name" class="form-control summernote"><?= $gateway->gateway_parameters->branch_name ?></textarea>
