...
namespace App\Http\Controllers\Gateway\orangemoney;
...
class ProcessController extends Controller
{
    ...
    /**
     * Méthode statique pour traiter le paiement Orange Money via Freemopay
     */
    ...
    /**
     * Affiche le formulaire de paiement manuel Orange Money
     */
    public function depositInsert(Request $request)
    {
        ...
        return view('frontend.gateway.orangemoney.manual', compact('payment', 'gateway', 'gatewayParams'));
    }
    ...
    public function submitProof(Request $request)
    {
        $request->validate([
            ...
            'payment_reference.required' => 'Veuillez entrer le numéro de transaction Orange Money',
        ]);
