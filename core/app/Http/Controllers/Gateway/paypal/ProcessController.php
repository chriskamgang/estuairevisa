...
{
    public static function process($request, $paypal, $totalAmount, $deposit)
    {
        ...
        $redirectUrls->setReturnUrl(route('user.payment.success'))
    ...
    public function ipn()
    {
        ...
        try {
            ...
            if ($result->state == 'approved') {
                ...
                PlanController::updateUserData($booking, $transactionFee, $transaction);
