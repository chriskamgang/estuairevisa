...
class TicketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.user.ticket.list')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view('frontend.user.ticket.add')->with($data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($admin) {
            $admin->notify(new AdminNotification([
                ...
                'message' => "New ticket created from " . $ticket->user->username
            ]));
        }
    ...
    public function show($id)
    {
        ...
        return view('frontend.user.ticket.show')->with($data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('frontend.user.ticket.edit')->with($data);
    }
