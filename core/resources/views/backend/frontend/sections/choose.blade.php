<section class="choose-section">
  <div class="container">
    <div class="row gy-4 align-items-center">
      <div class="col-lg-6">
        <span class="section-caption"><i class="fa-solid fa-plane-departure"></i> {{ __("Why Choose Us") }}</span>
        <h2 class="section-title mt-3">{{ __("Experience the Difference with Us") }}</h2>
        <p class="mb-0">{{ __("Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos odio quas officiis excepturi saepe minima quidem rem maxime? Fugit cumque ullam dolores") }}</p>
