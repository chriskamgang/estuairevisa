                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="button_text" class="form-control"
                                            placeholder="Cookie Button Text" value="{{ $cookie->button_text }}">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="">{{ __('Cookie Button Link') }}</label>
                                        <input type="text" name="cookie_link" class="form-control"
                                            placeholder="Cookie Button Link" value="{{ $cookie->cookie_link }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <button type="submit"
                                            class="btn btn-primary float-right">{{ __('Update Cookie Consent') }}</button>
