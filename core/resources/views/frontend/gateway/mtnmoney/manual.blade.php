...
@section('content2')
    <div class="row gy-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="background: linear-gradient(135deg, #FFCC00 0%, #FFD700 100%);">
                    <h4 class="mb-0 text-dark">
                        <i class="bi bi-phone"></i> {{ __('Paiement MTN Mobile Money') }}
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <ol class="mb-0">
                            <li>{{ __('Composez *126# sur votre téléphone MTN Mobile Money') }}</li>
