        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header text-center" style="background: linear-gradient(135deg, #FF7900 0%, #FF9933 100%);">
                    <h5 class="text-white">{{ __('Orange Money Payment') }}</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="alert alert-info mt-4">
                        ...
                        <ul class="mb-0">
                            <li>{{ __('Entrez votre numéro Orange Money (format: 237XXXXXXXXX)') }}</li>
                            <li>{{ __('Vous recevrez une notification pour valider le paiement sur votre téléphone') }}</li>
                            <li>{{ __('Composez #150# pour vérifier votre solde Orange Money') }}</li>
                        </ul>
                    </div>
                    ...
                    <form action="{{ url('gateways/' . $gateway->id . '/details') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="phone_number" class="form-label">
                                <i class="bi bi-telephone-fill"></i> {{ __('Numéro Orange Money') }} *
                            </label>
                            <input type="text"
                                   name="phone_number"
                                   id="phone_number"
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="bi bi-phone"></i> {{ __('Pay With Orange Money') }}
                            </button>
