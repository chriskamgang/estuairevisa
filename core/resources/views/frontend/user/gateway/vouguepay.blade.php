                            ...
                            <div class="row">
                                <div class="card-body text-center">
                                    ...
                                    <form method='POST' action='https://pay.voguepay.com'>
                                        <input type="hidden" name='v_merchant_id'
                                            value="{{ $vouguePayParams->marchant_id }}" />
                                        <input type="hidden" name='merchant_ref'
                                            value="{{ $vouguePayParams->merchant_ref }}" />
                                        ...
                                        <input type="hidden" name='cur'
                                            value="{{ $vouguePayParams->currency }}" />
                                        ...
                                        <input type="hidden" name='success_url'
                                            value="{{ route('user.vouguepay.redirect') }}" />
                                        <button type='submit' class="btn btn-primary">{{ __('Pay Via Voguepay') }}</button>
                                    </form>
