                    ...
                    <div id="documents-wrapper">
                        <div class="d-flex flex-wrap align-items-center gap-2 justify-content-sm-between justify-content-center mb-sm-5 mb-4">
                            ...
                            <p class="mb-0 d-flex align-items-center gap-2 justify-content-end"><?php echo e(__('Price')); ?>: <b
                                    class="text-dark text-xl"><?php echo e(number_format($plan->price, 2).' '.$general->site_currency); ?></b></p>
                        </div>
                        ...
                        <form method="post" enctype="multipart/form-data" id="documentForm">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    <h6 class="text-center"><?php echo e(__("Please Upload the Following Documents")); ?></h6>
                                    <div class="d-flex align-items-center justify-content-center gap-2 mt-sm-5 mt-4">
                                        <p class="mb-0"><?php echo e(__("Accepted Formats")); ?>: <span class="text-primary"><?php echo e(__("PDF, JPG or
                                                PNG")); ?></span>
                                        </p>
                                    </div>
                                    ...
                                    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-2 gy-4 mt-2 justify-content-center">
                                        ...
                                        <div class="col">
                                            <div class="upload-system-item">
                                                ...
                                                <p><?php echo e($k+1); ?> <?php echo e($field->label); ?></p>
                                                <div class="file-show-list">
        
                                                </div>
                                                <div class="text-end">
                                                    <input type="file" name="<?php echo e($field->name); ?>" id="file-upload-<?php echo e($k); ?>"
                                                        class="file-upload-field">
                                                    <label for="file-upload-<?php echo e($k); ?>" class="text-primary"><i
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-3 mt-sm-5 mt-4">
                                        <a href="<?php echo e(route('home')); ?>"
                                            class="btn btn-md btn-outline-secondary cancel-btn"><?php echo e(__("Cancel")); ?></a>
                                        <button type="button" id="details-btn"
                                            class="btn btn-md btn-primary fetch-details-btn"><?php echo e(__("Details")); ?>
...
<script>
    ...
    try {
        ...
        const response = await $.ajax({
            url: "<?php echo e(route('visa.applay.submit.documents')); ?>",
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false
...
</script><?php /**PATH /Users/redwolf-dark/estuairevisa/core/resources/views/frontend/form_modals/wrapper/documents-wrapper.blade.php ENDPATH**/ ?>