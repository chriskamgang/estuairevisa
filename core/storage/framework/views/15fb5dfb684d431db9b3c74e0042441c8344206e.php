...
<div class="row g-3">
    ...
    <div class="col-lg-4 col-12">
        <div class="nir-user-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
            ...
            <div class="content">
                <p class="mb-2 text-white"><?php echo e(__("Notifications Push")); ?></p>
                <?php if(auth()->user()->push_notification_enabled): ?>
                    <span class="badge bg-success">
                        <i class="bi bi-check-circle"></i> <?php echo e(__("Activées")); ?>

                    </span>
                <?php else: ?>
                    <button id="enable-notifications-btn" class="btn btn-sm btn-light mt-2">
                        <i class="bi bi-bell-fill"></i> <?php echo e(__("Activer")); ?>
