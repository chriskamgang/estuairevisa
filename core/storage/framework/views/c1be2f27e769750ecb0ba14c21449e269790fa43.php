    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body pt-5">
                <p class="text-lg text-center mb-5"><?php echo e(__("Please tell us where are you from and where do you live")); ?></p>
                ...
                <div class="d-flex align-items-center justify-content-end gap-3 mt-5">
                    ...
                    <button type="button" class="btn btn-md btn-primary fetch-visa_info-btn"><?php echo e(__("Next")); ?> <i
...
</script><?php /**PATH /Users/redwolf-dark/estuairevisa/core/resources/views/frontend/form_modals/countries.blade.php ENDPATH**/ ?>