    ...
    <div class="visa-package-wrapper" id="package_section">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                ...
                <p><?php echo e(__(@$content->data->subtitle)); ?></p>
        ...
        <div class="tab-content mt-4" id="visaTabContent">
            <div class="tab-pane fade show active" id="single" role="tabpanel" aria-labelledby="single-tab">
                <div class="row gy-4 mt-4 justify-content-center align-items-center">
                    <?php $__empty_1 = true; $__currentLoopData = $singlePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 col-sm-6">
                        <div class="visa-package" <?php echo e($plan->is_recommended ? "data-title=Recommended" : ''); ?>>
                            ...
                            <button type="button" class="package-btn fetch-country-btn"
                                data-plan="<?php echo e(route('visa.applay.start',$plan->id)); ?>"><?php echo e(__("Get Started")); ?></button>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center">
                        <p><?php echo e(__("No single entry packages found.")); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="multi" role="tabpanel" aria-labelledby="multi-tab">
                <div class="row gy-4 mt-4 align-items-center">
                    <?php $__empty_1 = true; $__currentLoopData = $multiPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 col-sm-6">
                        <div class="visa-package" <?php echo e($plan->is_recommended ? "data-title=Recommended" : ''); ?>>
                            <h3 class="title mb-0"><?php echo e($plan->title); ?></h3>
                            <p><?php echo e($plan->heading); ?></p>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center">
                        <p><?php echo e(__("No multiple entry packages found.")); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<script>
    ...
    $(function(){
        ...
        $(document).on('click', '.fetch-visa_info-btn', async function () {
            ...
            try {
                const response = await $.get("<?php echo e(route('visa.applay.infos')); ?>", { from, live });
    ...
    $.ajax({
        url: "<?php echo e(route('visa.country.search')); ?>",
        method: 'get',
        data: {
            from_id: from,
            to_id: live
