...
<div class="row row-cols-lg-5 row-cols-md-3 row-cols-2  rowcols gy-4 justify-content-center">
    <?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      ?>
      <div class="col">
        <div class="featured-on-item text-center" style="cursor: pointer;" onclick="openFeaturedModal(<?php echo e($element->id); ?>)" title="<?php echo e(__('Cliquez pour voir les détails')); ?>">
          <div class="featured-image-wrapper mb-3">
            <img src="<?php echo e(getFile('featured', $element->data->image)); ?>" alt="<?php echo e(__($element->data->title)); ?>" class="featured-image">
          </div>
          <h3 class="title mb-2"><?php echo e(__($element->data->title)); ?></h3>
          <?php if(!empty($shortDescription)): ?>
            <p class="short-desc text-muted small"><?php echo e(__($shortDescription)); ?></p>
          <?php endif; ?>
          <div class="mt-2">
            <small class="text-primary"><i class="fas fa-info-circle"></i> <?php echo e(__('En savoir plus')); ?></small>
          </div>
        </div>
      </div>
...
<!-- Modals pour chaque procédure de visa -->
<?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <?php
      $description = $element->data->description ?? '';
  ?>

  <div class="modal fade" id="featuredModal<?php echo e($element->id); ?>" tabindex="-1" aria-labelledby="featuredModalLabel<?php echo e($element->id); ?>" aria-hidden="true">
      ...
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <div class="d-flex align-items-center">
            <img src="<?php echo e(getFile('featured', $element->data->image)); ?>" alt="<?php echo e(__($element->data->title)); ?>" style="max-width: 60px; height: auto; margin-right: 15px; background: white; padding: 5px; border-radius: 8px;">
            <h4 class="modal-title mb-0" id="featuredModalLabel<?php echo e($element->id); ?>">
              <?php echo e(__($element->data->title)); ?>
        ...
        <div class="modal-footer" style="z-index: 10005 !important;">
          <button type="button" class="btn btn-secondary" onclick="event.stopPropagation(); closeFeaturedModal(<?php echo e($element->id); ?>); return false;" style="z-index: 10006 !important; pointer-events: auto !important;">
            <i class="fas fa-times"></i> <?php echo e(__('Fermer')); ?>
...
</script><?php /**PATH /Users/redwolf-dark/estuairevisa/core/resources/views/backend/frontend/not_editable/featured.blade.php ENDPATH**/ ?>