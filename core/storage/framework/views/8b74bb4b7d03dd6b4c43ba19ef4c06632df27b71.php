                ...
                <div class="mt-5">
                    <div id="details-wrapper">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2 justify-content-sm-between justify-content-center mb-sm-5 mb-4">
                            <p class="text-xl text-uppercase text-primary mb-0"><?php echo e($plan->title); ?>   <span class="visa-package-country text-nowrap"> <?php echo e(__('Visa for:')); ?> <?php echo e($plan->country->name); ?></span></p>
                            <p class="mb-0 d-flex align-items-center gap-2 justify-content-end"><?php echo e(__('Price')); ?>:
                            <b class="text-dark text-xl"><?php echo e(number_format($plan->price, 2).' '.$general->site_currency); ?></b></p>
                        </div>
        
                        <h6 class="text-center mb-5"><?php echo e(__('Please Provide The Following Details')); ?></h6>
                            ...
                            <div class="row gy-4">
                                <div class="col-lg-6">
                                    ...
                                    <div class="visa-icon-field">
                                        ...
                                        <input type="number" name="phone_number" placeholder="<?php echo e(__(' Phone Number')); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="visa-icon-field">
                                        ...
                                        <input type="text" name="email_address" placeholder="<?php echo e(__(' Email address')); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="visa-icon-field">
                                        ...
                                        <input type="text" name="from" value="<?php echo e($from->name); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label"><?php echo e(__('Live in')); ?></label>
                                    <div class="visa-icon-field">
                                        <i class="bi bi-globe-americas"></i>
                                        <input type="text" name="live" value="<?php echo e($live->name); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label"><?php echo e(__('Passport number')); ?></label>
                                    <div class="visa-icon-field">
                                        <i class="bi bi-passport"></i>
                                        <input type="text" name="passport_number" placeholder="<?php echo e(__(' Passport number')); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label"><?php echo e(__('Profession')); ?></label>
                                    <div class="visa-icon-field">
                                        <i class="bi bi-briefcase"></i>
                                        <input type="text" name="profession" placeholder="<?php echo e(__(' Profession')); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label"><?php echo e(__('Travel date')); ?></label>
                                    <div class="visa-icon-field">
                                        <i class="bi bi-calendar4-week"></i>
                                        <input type="date" name="travel_date" placeholder="<?php echo e(__(' Travel date')); ?>"
                                            autocomplete="off" min="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label"><?php echo e(__('Travel purpose')); ?></label>
                                    <div class="visa-icon-field">
                                        <i class="bi bi-suitcase"></i>
                                        <input type="text" name="travel_purpose" placeholder="<?php echo e(__(' Travel purpose')); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-3 mt-sm-5 mt-4">
                            <a href="<?php echo e(route('home')); ?>" class="btn btn-md btn-outline-secondary"><?php echo e(__('Cancel')); ?></a>
                            <button type="button" class="btn btn-md btn-primary fetch-review_btn"><?php echo e(__('Review')); ?> <i class="bi bi-chevron-right"></i></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).off('click', '.fetch-review_btn').on('click', '.fetch-review_btn', async function(e) {
            ...
            try {
                ...
                const response = await $.ajax({
                    url: "<?php echo e(route('visa.applay.info.submit')); ?>",
                    method: 'POST',
                    data: data
                });
...
</script><?php /**PATH /Users/redwolf-dark/estuairevisa/core/resources/views/frontend/form_modals/wrapper/details-wrapper.blade.php ENDPATH**/ ?>