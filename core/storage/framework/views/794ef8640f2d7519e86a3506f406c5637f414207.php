                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 mb-3">
                                        <label class="col-form-label"><?php echo e(__('Orange Money Image')); ?></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            ...
                                            <ul class="mb-0">
                                                ...
                                                <li><?php echo e(__('Les paiements Orange Money seront traités automatiquement')); ?></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <button type="submit"
                                        class="btn btn-primary float-right"><?php echo e(__('Update Orange Money Information')); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/redwolf-dark/estuairevisa/core/resources/views/backend/gateways/orangemoney.blade.php ENDPATH**/ ?>