...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('asset/admin/css/image-uploader.min.css')); ?>">
...
<body>
    ...
    <script src="<?php echo e(asset('asset/admin/js/image-uploader.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('asset/admin/js/iconify-icon.min.js')); ?>"></script>
    ...
    <script>
        $(function() {
            ...
            <?php if(session('locale') == null): ?>

                $('.changeLang').val("<?php echo e($default->short_code); ?>")
            <?php endif; ?>
...
<?php /**PATH /Users/redwolf-dark/estuairevisa/core/resources/views/backend/layout/master.blade.php ENDPATH**/ ?>